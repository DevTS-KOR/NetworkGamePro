...
void CSceneMgr::SendInfo(Vec3 _Position, float _RotateCamera)
{
	int retval;
	int dataType = DataType::PLAYER;
	...
	tempPlayerInfo.CameraDir = { _RotateCamera,_RotateCamera, _RotateCamera };
